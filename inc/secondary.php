...
<aside class="education aside section">
	<div class="section-inner">
		...
		<div class="content">
            <div class="item">
				<h3 class="title"><i class="fa fa-graduation-cap"></i> Master 2 Informatique AIGLE</h3>
				<h4 class="university">Université Montpellier II <span class="year">(2015 - En cours)</span></h4>
			</div><!--//item-->
			<div class="item">
				<h3 class="title"><i class="fa fa-graduation-cap"></i> Master 1 Informatique IMAGINA</h3>
				<h4 class="university">Université Montpellier II <span class="year">(2014 - 2015)</span></h4>
			</div><!--//item-->
			<div class="item">
				<h3 class="title"><i class="fa fa-graduation-cap"></i> Licence Informatique</h3>
				<h4 class="university">Université Montpellier II <span class="year">(2013-2014)</span></h4>
			</div><!--//item-->
			<div class="item">
	...
	<div class="section-inner">
		...
		<div class="content">
			...
			<div class="skillset">
				...
				<div class="item">
					<h3 class="level-title">Technologies du web<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="Très bonnes connaisances des dernières technologies du web (HTML5, CSS (Less, Sass), Boostrap, PHP avancé (Symfony), Javascript, jQuery, NodeJS)"><i class="fa fa-info-circle"></i></span></h3>
					<div class="level-bar">
                ...
                <div class="item">
					<h3 class="level-title">Golang<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true"></span></h3>
					<div class="level-bar">
				...
				<div class="item">
					<h3 class="level-title">Design<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="Intéret pour la création visuelle. Maitrise de Photoshop. Edition Vidéo (Première Pro / After Effect)"><i class="fa fa-info-circle"></i></span></h3>
					<div class="level-bar">
