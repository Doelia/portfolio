...
<section class="about section">
	<div class="section-inner">
		...
		<div class="content">
			<p>Je suis un développeur passioné par l'informatique agé de 23 ans. Je pratique surtout dans le monde du web, sur les sytèmes de communcations.</p>		 
			<p></p>
		</div><!--//content-->
	</div><!--//section-inner-->                 
</section><!--//section-->
...
<section class="latest section">
	<div class="section-inner">
		<h2 class="heading">Derniers projets</h2>
		<div class="content">    
