...
<aside class="education aside section">
	<div class="section-inner">
		...
		<div class="content">
			<div class="item">                      
				<h3 class="title"><i class="fa fa-graduation-cap"></i> Master Informatique IMAGINA</h3>
				<h4 class="university">Université Montpellier II <span class="year">(2014 - En cours)</span></h4>
			</div><!--//item-->
			<div class="item">
