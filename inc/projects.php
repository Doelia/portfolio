...
<div class="item row">
    ...
    <div class="content">
        ...
        <p>
            ...
            Il comprend une couche de protocole d'échange entièrement synchrone avec le protocole HTTP.
        </p>
        <p>
            Le jeu dispose d'un lobby et le serveur peut faire tourner plusieurs parties en même temps.
            Une partie peut être rejointe par 2 à 4 joueurs. La presque totalité des cartes du jeu de base ont été implémentées.
        </p>
        <p>
        ...
        <div class="links">
            ...
            <a class="ui primary button tiny" href="https://github.com/doelia/dominion" target="_blank"><i class="fa fa-github"></i> Github</a>
        </div>
    </div>
</div>
